...
def index():
    ...
    # Comparison - Process the Dataset Upload Form
    if request.method == "POST":
        try:
            ...
            if selected_training_percentage < 1 or selected_training_percentage > 99:
                raise UserError(
            ...
            # Comparison - Read Dataset Columns and Preview Rows
            uploaded_dataset = inspect_dataset(
                stored_path,
                original_filename,
            )

            # Comparison - Use Final Dataset Column as Prediction Target
            ...
            # Comparison - Upload Dataset, Run Models and Return Results
            result = run_dataset(
